...
> qwen3.6-27b-vision:  `llama-server.exe -hf unsloth/Qwen3.6-27B-MTP-GGUF:Q4_K_S -ngl 99 -c 81768 -fa on -np 1 --tools all --alias qwen3.6-27b-vision --spec-type draft-mtp --spec-draft-n-max 2 --spec-draft-p-min 0.75  --tools all`
